...
public class CatalogItemController : ControllerBase
{
        ...
        [FromBody] CreateCatalogItemDTO? dto)
    {
        ...
        var command = new CreateCatalogItemCommand(
            ...
            dto.AvailableStock, dto.RestockThreshold,
    ...
    public async Task<IActionResult> UpdateCatalogItem(
        Guid id, [FromBody] UpdateCatalogItemDTO? dto)
    {
        if (dto == null)
            return BadRequest();

        var updateCommand = new UpdateCatalogItemCommand(
            id, dto.Name, dto.Description, dto.Price, dto.AvailableStock,
